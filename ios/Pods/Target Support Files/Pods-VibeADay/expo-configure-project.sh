...
with_node \
  ...
  --target "/Users/PTerras/Documents/VibeADay/ios/Pods/Target Support Files/Pods-VibeADay/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-system-ui" "expo-updates" "expo-web-browser"
